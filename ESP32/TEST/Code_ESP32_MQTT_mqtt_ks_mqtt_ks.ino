 ...
 */
const unsigned char  ks_pk_key[] = "-----BEGIN PUBLIC KEY-----\n"\
...
/* public key 1024 bit */
const unsigned char iot_pk_key[]= "-----BEGIN PUBLIC KEY-----\n"\
...
const unsigned char iot_pr_key[]= "-----BEGIN RSA PRIVATE KEY-----\n"\
...
const char* mqtt_server =  "192.168.0.108"; //"mqtt.eclipse.org";
...
{
    size_t cred_len ; /* credential lenght*/
    size_t sig_len = 128 ;  /*signature lenght*/
    ...
    unsigned char cred[]= "KeyNote-Version: 2\n"\
    ...
    #ifdef TIME_DEBUG
      Serial.print("Time to sing the credential :");
    ...
    len = rsa_encryption(key,BLOCK_SIZE,cipher); /* we need to check the lenght here*/
    ...
    */
    ...
    digitalWrite(13, HIGH);
    #endif
    client.beginPublish(k_topic, m_len, true); 
    client.write((byte *)message, m_len); 
    client.endPublish ();
 ...
 void Datatransmission(int value)
 {
    ...
    digitalWrite(13, HIGH);
    #endif
    client.beginPublish(topic, Size_Byte, true); 
    client.write((byte *)output, (int)Size_Byte); 
    client.endPublish ();
    #ifdef OSLOENABLE
    digitalWrite(13, LOW);
    #endif
